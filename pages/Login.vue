        ...
        <div class="relative bg-white p-10 rounded-lg text-center w-[40rem] sm:w-[400px]">
            ...
            <form class="flex flex-col gap-4 w-full">
                ...
                <div class="flex flex-col">
                    ...
                    <input
                        v-model="signUpFields[0].value"
                        type="email"
                        id="Email"
                        name="Email"
                        placeholder="Enter your email"
                        class="border-none rounded bg-transparent text-gray-200 w-full focus:outline-none focus:ring-0 focus:bg-orange-700 px-4 py-2 mb-4"
                    />
                </div>
                ...
                <Button 
                    variant="outline"
                    @click="handleSignUp"
                    class="bg-slate-700 hover:bg-gray-700 hover:text-gray-100 mb-4"
                >
                    Submit
                </Button>
                
                <div class="flex justify-center items-center">
                    <span class="text-sm text-gray-500 mr-2">New User?</span>
                    <Button variant="link" class="text-sm text-blue-500 hover:text-blue-700">Create an account</Button>
                </div>
            </form>
        </div>
    </div>
